...
const Details = ({propertyDetail}) => {
  ...
  return (
    ...
    <div id="details" className='lg:mx-16 items-center mx-4 py-4 lg:pt-12 lg:pb-12 grid grid-cols-1 gap-x-6 lg:gap-12 lg:grid-cols-2 grid-flow-row  '>
      ...
      <h3 className='font-[NeueMedium]  lg:text-[1.5rem]  text-[.8rem] ' >Exclusive CoLiving in Dhankawadi, Pune</h3>
        
        <h1 className='font-[NeueBold]  text-[1.5rem] leading-[1.5rem] lg:leading-[3rem]  uppercase lg:text-[2rem]' >Experience Modern Amenities and a Vibrant Community in Dhankawadi, Pune</h1>
        <p className='font-[NeueRegular]  text-[0.8rem]  lg:text-[1.1rem] ' > Discover the perfect blend of comfort and community in Dhankawadi, Pune. Our co-living space offers modern amenities, high-speed Wi-Fi, and engaging events for an unparalleled living experience.</p>
