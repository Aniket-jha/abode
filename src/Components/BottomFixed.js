...
const BottomNavConstant = ({propertyDetail}) => {
  return (
    ...
    <div>
        <h3 className='font-[NeueMedium] lg:text-left text-center text-[1.2rem]  text-[#272727] capitalize lg:text-[2rem]'>Abode</h3>
        <h3 className='font-[NeueRegular] lg:text-left text-center lg:text-[1rem]  text-[.7rem] ' >Starting At: Rs.7,999</h3>
    </div>
